# Generated by Django 3.1.4 on 2021-03-04 10:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bid', models.ManyToManyField(default=None, to='auctions.Bid')),
                ('category', models.ForeignKey(default='None', on_delete=django.db.models.deletion.CASCADE, to='auctions.category')),
                ('comment', models.ManyToManyField(default=None, to='auctions.Comment')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
